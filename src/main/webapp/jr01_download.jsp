...
<html>
  <head>
    <meta charset="UTF-8">
    <title>JR01 Download</title>
    <link rel="stylesheet" href="<c:url value='/styles/main.css'/>" type="text/css"/>
  </head>
  <body>
    <h1>Download</h1>
    <h2>JACK - J97 | LIỄU THANH YÊN </h2>

    <%-- Tạo URL an toàn (có context path) cho các file MP3 --%>
    <c:url var="mp3_1" value="/musicStore/sound/jr01/JACKJ97LieuThanhYen.mp3"/>
    <c:url var="mp3_2" value="/musicStore/sound/jr01/JACKJ97LieuThanhYen.mp3"/>
