...
<html>
  <head>
    <meta charset="UTF-8">
    <title>J97 Download</title>
    <link rel="stylesheet" href="<c:url value='/styles/main.css'/>" type="text/css"/>
  </head>
  <body>
    <h1>Download</h1>
    <h2>Jack - J97 | Hoa Diên Vĩ</h2>

    <%-- Tạo URL an toàn (có context path) cho các file MP3 --%>
    <c:url var="mp3_1" value="/musicStore/sound/8601/JackJ97HoaDienVi.mp3"/>
    <c:url var="mp3_2" value="/musicStore/sound/8601/JackJ97HoaDienVi.mp3"/>
