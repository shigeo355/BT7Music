...
<html>
  ...
  <body>
    <h1>Download</h1>
    <h2>JACK - J97 | TRẠM DỪNG CHÂN </h2>

    <%-- Tạo URL an toàn (có context path) cho các file MP3 --%>
    <c:url var="mp3_1" value="/musicStore/sound/pf01/JACKJ97TramDungChan.mp3"/>
    <c:url var="mp3_2" value="/musicStore/sound/pf01/JACKJ97TramDungChan.mp3"/>
